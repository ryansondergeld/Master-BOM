            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 mx-auto" id="content-column" style="width: 353px;">
                ...
                <section id="list-section">
                    ...
                    foreach($p->companies as $company)
                    {
                        ...
                        echo '<h4 class="card-title">' . $company->name . '</h4>';

                        // If vendor
                        if($company->is_vendor)
                        {
                            echo "<a href=" . ROOT . "read-part/where/vendor/" . $company->id . " class='card-link'>Parts from this vendor</a>";
                            echo '<br>';
                        }
                        ...
                        {
                            echo "<a href=" . ROOT . "read-part/where/manufacturer/" . $company->id . " class='card-link'>Parts by this manufacturer</a>";
                            echo '<br>';
                        }

                        echo "<a href=" . ROOT . "update-company/load/" . $company->id . " class='card-link'><i class='typcn typcn-edit w-100' style='text-align: center;font-size: 36px;'></i></a>";
                        echo '</div>';
                        echo '</div>';
                    }
                    ?>
