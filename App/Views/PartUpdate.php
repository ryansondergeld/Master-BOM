        ...
        <div class="row" id="content-row" >
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 mx-auto" id="content-column" style="width: 353px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <?php if($p->user['level'] < 2) {
                                echo '<div class="text-end"><a href="'. ROOT .'update-part/delete/' . $p->values['id'] . '" style="color: var(--bs-danger);">X Delete</a></div>';
                            } ?>
                        </div>
                    </div>
                </section>
                <section id="login-form-section">
                    <div class="card">
                        <div class="card-body">
                            <form id="user-login-form" action="<?=ROOT?>update-part/process" method="post">
                                ...
                                <div id="article-number-div" style="margin-bottom: 16px;">
                                    ...
                                    <input class="form-control" type="text" name="article_number" placeholder="Article Number" <?php if(isset($p->values['article_number'])) { echo "value='" . $p->values['article_number'] . "'";} ?>>
                                </div>
                                ...
                                <div id="submit-button-div"><button class="btn btn-primary d-block w-100" type="submit">Update</button></div>
                            </form>
                        </div>
                    </div>
                </section>
